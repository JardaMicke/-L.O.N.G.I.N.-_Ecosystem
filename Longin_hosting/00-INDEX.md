...
### 🇨🇿 **7. Český Návod na Nasazení (TUTORIAL)**
- **Soubor:** `docs/TUTORIAL_NASAZENI.md`
- **Obsah:**
  - Krok-za-krokem návod na nasazení (VPS, Docker)
  - Konfigurace .env
  - Spuštění v produkci
  - Údržba a aktualizace
- **Jazyk:** Čeština
- **Důležitost:** 🟢 UŽITEČNÉ - Pro nasazení do produkce
